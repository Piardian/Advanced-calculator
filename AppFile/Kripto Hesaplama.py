...
API_KEY = 'kqVBg2uJYb6HHm3vgSinGLRBHgj7EYp3niRIOWXaOYLGk2q6BRIGC5pfMQT2js6M'

# Binance API Base URL
BASE_URL = 'https://api.binance.com/api/v3/ticker/price?symbol='

# Binance API'ye GET isteği yapacak fonksiyon
...
combobox1 = ttk.Combobox(window, textvariable=secim_var1, values=secenekler1, state="readonly")
...
combobox2 = ttk.Combobox(window, textvariable=secim_var2, values=secenekler2, state="readonly")
